...
const validateMbId = require("../utils/validateMb");
...
const loginUserController = asyncHandler(async (req, res) => {
  ...
  if (findUser && (await findUser.isPasswordMatcher(password))) {
...
const loginAdmin = asyncHandler(async (req, res) => {
  ...
  if (findAdmin && (await findAdmin.isPasswordMatcher(password))) {
